...
root_dir = 'D:\\BaiduNetdiskDownload\\tuxiang'
...
def my_own_training_set(onlyDB=False):
    structFile = join(struct_dir, 'new.mat')
    return WholeDatasetFromStruct(structFile,input_transform=
                                  transforms.Compose([
                                      transforms.ToTensor(),
                                      transforms.Resize(size=(640, 440)),
                                      transforms.Normalize(mean=[0.485, 0.456, 0.406],
                                                           std=[0.229, 0.224, 0.225])]),
                                  onlyDB=onlyDB)
...
class WholeDatasetFromStruct(data.Dataset):
    ...
    def getPositives(self):
        ...
        if  self.positives is None:
            ...
            # posDistThr=25  25m以内都是测试计算recall的ground truth
...
class QueryDatasetFromStruct(data.Dataset):
    def __init__(self, structFile, nNegSample=1000, nNeg=10, margin=0.1, input_transform=None):
        ...
        self.whichSet = self.dbStruct.whichSet
        self.dataset = self.dbStruct.dataset
        self.nNegSample = nNegSample # number of negatives to randomly sample 1000
        self.nNeg = nNeg # number of negatives used for training 10
        ...
        # [   0    1    2 ... 7413 7414 7415] 长度为7320 7416-7320=96=24*4  4=batch_size FIXME 与batchsize 有关嘛
    ...
    def __getitem__(self, index):
        ...
        with h5py.File(self.cache, mode='r') as h5: 
            ...
            # negFeat = h5feat[negSample.tolist()] FIXME
...
train_set = get_training_query_set(0.1)
